...
# instance fields
.field public c:Lcom/facebook/login/GetTokenClient;
...
.method public final b()V
    ...
    .line 6
    iput-boolean v1, v0, Lcom/facebook/internal/PlatformServiceClient;->d:Z
    ...
    .line 9
    iput-object v1, v0, Lcom/facebook/internal/PlatformServiceClient;->c:Lw2;
...
.method public final l(Lcom/facebook/login/LoginClient$Request;)I
    ...
    .line 27
    :try_start_0
    iget-boolean v1, v0, Lcom/facebook/internal/PlatformServiceClient;->d:Z
    :try_end_0
    ...
    :cond_1
    :try_start_1
    iget v1, v0, Lcom/facebook/internal/PlatformServiceClient;->i:I
    ...
    .line 54
    sget-object v6, Lcom/facebook/internal/NativeProtocol;->b:Ljava/util/ArrayList;
    ...
    .line 60
    invoke-virtual {v5, v6, v1}, Lcom/facebook/internal/NativeProtocol;->h(Ljava/util/List;[I)Lcom/facebook/internal/NativeProtocol$ProtocolVersionQueryResult;

    move-result-object v1

    .line 64
    iget v1, v1, Lcom/facebook/internal/NativeProtocol$ProtocolVersionQueryResult;->a:I
    :try_end_2
    ...
    .line 68
    :try_start_3
    invoke-static {v4, v1}, Lcom/facebook/internal/instrument/crashshield/CrashShieldHandler;->a(Ljava/lang/Object;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :cond_3
    :try_start_4
    iget-object v1, v0, Lcom/facebook/internal/PlatformServiceClient;->a:Landroid/content/Context;
    ...
    .line 87
    :cond_4
    iput-boolean v3, v0, Lcom/facebook/internal/PlatformServiceClient;->d:Z

    .line 89
    iget-object v4, v0, Lcom/facebook/internal/PlatformServiceClient;->a:Landroid/content/Context;
    ...
    .line 103
    iget-object v0, v0, Lcom/facebook/login/LoginClient;->e:Lcom/facebook/login/LoginFragment$onCreateView$1;

    if-eqz v0, :cond_7

    .line 107
    iget-object v0, v0, Lcom/facebook/login/LoginFragment$onCreateView$1;->a:Lcom/facebook/login/LoginFragment;
    ...
    .line 131
    iget-object p0, p0, Lcom/facebook/login/GetTokenLoginMethodHandler;->c:Lcom/facebook/login/GetTokenClient;

    if-eqz p0, :cond_8

    .line 135
    iput-object v0, p0, Lcom/facebook/internal/PlatformServiceClient;->c:Lw2;
...
.method public final m(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    .line 9
    .line 10
    invoke-static {p2, v0}, Lcom/facebook/login/LoginMethodHandler$Companion;->a(Landroid/os/Bundle;Ljava/lang/String;)Lcom/facebook/AccessToken;
    ...
    .line 61
    .line 62
    sget-object v4, Lcom/facebook/login/LoginClient$Result$Code;->b:Lcom/facebook/login/LoginClient$Result$Code;
    ...
    .line 83
    invoke-static {p2, v1, p1, v1}, Lcom/facebook/login/LoginClient$Result$Companion;->b(Lcom/facebook/login/LoginClient$Request;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/login/LoginClient$Result;
